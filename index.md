...
### [heywhatson.tv](https://heywhatson.tv)

2026

A lightweight, static guide and search engine for TV channels and sporting events in France, Canada, UK, USA, Spain, Italy, Portugal.

### [Paseo PR Views](https://github.com/pmusaraj/paseo-pr-views)

2026

Saved GitHub PR searches, review status, and background notifications inside [Paseo](https://paseo.sh).

### [Standard.site plugin for Discourse](https://github.com/pmusaraj/discourse-standard-site)

2026

Publish public Discourse topics to the AT Protocol through [Standard.site](https://standard.site).

### [Discourse theme screenshots](https://github.com/pmusaraj/discourse-theme-screenshots)

2026

An experimental automated repo and script to take scheduled screenshots of Discourse themes. Helps make visual regressions easier to spot.

### [Discourse Tapestry connector](https://github.com/pmusaraj/discourse-tapestry-connector)

2025

Follow Discourse communities in [Tapestry](https://usetapestry.com), filtered by category or tag.

### [Discourse Discover](https://discover.discourse.com)

2024

You wanna see what the best Discourse communities out there are? This is for you, then.
...
Generates theme components replacing Font Awesome with other icon sets. Was pretty cool at the time, not as interesting in age of LLMs.
